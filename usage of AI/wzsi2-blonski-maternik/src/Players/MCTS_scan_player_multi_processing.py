import chess
from src.Games.Chess import no_display
from src.Games.Chess import no_display, play
import concurrent.futures
from multiprocessing import cpu_count
import random
from IPython.display import Code, display
def MCTS_scan_player_multi_processing(board, scans=10, max_depth=20):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        temp_ind = 0
        for result in executor.map(mcts_move_search, legal_moves):
            #print(result)
